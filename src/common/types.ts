...
import type { VoiceSetup } from './setup';
...
export interface AppState { recovery?: RecoveryView | null; voiceSetup?: VoiceSetup | null; localAiAvailable?: boolean; transcript?: string | null; currentWindowId?: number; activeTabTitle?: string; settings: Settings; macros: Macro[]; routines?: Routine[]; progress?: ExecutionProgress | null; hud: HudState; log: LogEntry[]; pending: PendingPlan | null; shortcut: string; engineOpen: boolean; listening: boolean; hasApiKey: boolean; library?: Library; question?: Question | null; dictation?: PageRef | null; contextTargets?: TabRef[]; activeSiteOrigin?: string; }
